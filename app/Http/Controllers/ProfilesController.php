...
class ProfilesController extends Controller
{
    public function index(User $user)
    {
        ...
        $booksCount = Cache::remember('count.books.' . $user->id, now()->addSeconds(30), function () use ($user) {
        ...
        return view('profiles.index', compact('user', 'follows', 'booksCount', 'followersCount', 'followingCount'));
    }
